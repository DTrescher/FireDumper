...
namespace FireDumper.Utils.PE._64
{
    public class PE64File : PEFile
    {
        ...
        public override void AlignSectionHeaders()
        {
            ...
            {
                t.Header.VirtualAddress = AlignValue(t.Header.VirtualAddress, PEHeader.OptionalHeader.SectionAlignment);
                t.Header.VirtualSize = AlignValue(t.Header.VirtualSize, PEHeader.OptionalHeader.SectionAlignment);
                t.Header.PointerToRawData = AlignValue((uint)newFileSize, PEHeader.OptionalHeader.FileAlignment);
                t.Header.SizeOfRawData = AlignValue((uint)t.DataSize, PEHeader.OptionalHeader.FileAlignment);

                newFileSize = (int)(t.Header.PointerToRawData + t.Header.SizeOfRawData);
            }
