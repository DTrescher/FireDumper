...
namespace FireDumper.Utils.PE
{
    public static class NativePEStructs
    {
        ...
        public struct IMAGE_NT_HEADERS32
        {
            ...
            public bool IsValid => _Signature == "PE\0\0" && OptionalHeader.Magic == IMAGE_NT_OPTIONAL_HDR32_MAGIC;
        }
        ...
        public struct IMAGE_NT_HEADERS64
        {
            ...
            public bool IsValid => _Signature == "PE\0\0" && OptionalHeader.Magic == IMAGE_NT_OPTIONAL_HDR64_MAGIC;
        }
